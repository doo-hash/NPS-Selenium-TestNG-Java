...
public class HomePageMobileViewTest extends BaseClass {
	
	@Test(priority = 1, dependsOnMethods = "com.novoproso.testCases.ClickStartNowTest.clickStartNowButtonMobileViewTest")
	...
	@Test(priority = 2, dependsOnMethods = "com.novoproso.testCases.ClickStartNowTest.clickStartNowButtonMobileViewTest")
	public void productsSectionTest() throws InterruptedException {
		...
		wait.until(d -> header.isProductsLinkVisible());
	...
	@Test(priority = 3, dependsOnMethods = "com.novoproso.testCases.ClickStartNowTest.clickStartNowButtonMobileViewTest")
	public void servicesSectionTest() throws InterruptedException {
		...
		logger.info("toggle button is clicked!");
		wait.until(d -> header.isHomeLinkVisible());
		wait.until(d-> header.isServicesLinkVisible());
	...
	@Test(priority = 4, dependsOnMethods = "com.novoproso.testCases.ClickStartNowTest.clickStartNowButtonMobileViewTest")
	public void careersSectionTest() throws InterruptedException {
		...
		logger.info("toggle button is clicked!");
		wait.until(d -> header.isHomeLinkVisible());
		wait.until(d -> header.isContactLinkVisible());
	...
	@Test(priority = 5, dependsOnMethods = "com.novoproso.testCases.ClickStartNowTest.clickStartNowButtonMobileViewTest")
	public void contactSectionTest() throws InterruptedException {
		...
		executor.executeScript("arguments[0].scrollIntoView();", mapIframe);
